...
extern void Chip8_SubtractRegisterYbyRegisterX_8xy7(Chip8* chip8,
                                                    uint16_t memory);
extern void Chip8_ShiftRegisterXLeft_8xyE(Chip8* chip8, uint16_t memory);
extern void Chip8_SkipIfRegisterXDoesNotEqualRegisterY_9xy0(Chip8* chip8,
                                                            uint16_t memory);
