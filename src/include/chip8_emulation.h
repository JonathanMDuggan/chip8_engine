...
extern uint8_t Chip8_Emulate(const char* file_name, SDL* sdl);
extern void Chip8_ProcessInstruction(
    Chip8* chip8, uint16_t opcode, Chip8_OpcodeHandler* nnn,
    Chip8_OpcodeHandler* kk, Chip8_OpcodeHandler* _8xy, Chip8_OpcodeHandler* fx,
    Chip8_OpcodeHandler* xy, Chip8_OpcodeHandler* x);
