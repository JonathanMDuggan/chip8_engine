...
enum Chip8_Constants {
  ...
  kChip8MaxRAMSize = 4096,
  kChip8MaxStackSize = 16,
  // Chip8 screen specs is 64 by 32 pixels
  kChip8ScreenLength = 64,
  kChip8ScreenHeight = 32,
  kChip8FontSetSize = 80,
  kChip8Background = 0,
  kChip8Foreground = 0xFFFFFFFF,
  ...
  // Memory Locations
  kChip8StackBase = 0x200,
  kChip8FontSetAddress = 0x00,
  kChipNothingSpace = 0x80,
  // Memory Space
  ...
  // program counter
  kChip8NextInstruction = 2,
  kChip8SkipNextInstruction = 4,

  kChip8InstructionsPerSecond = 700,
  kChip8ScreenRefreshRate = 60
};

enum Chip8_InputMask {
  kChip8KeyPad0 = 0x0001,
  kChip8KeyPad1 = 0x0002,
  kChip8KeyPad2 = 0x0004,
  kChip8KeyPad3 = 0x0008,
  kChip8KeyPad4 = 0x0010,
  kChip8KeyPad5 = 0x0020,
  kChip8KeyPad6 = 0x0040,
  kChip8KeyPad7 = 0x0080,
  kChip8KeyPad8 = 0x0100,
  kChip8KeyPad9 = 0x0200,
  kChip8KeyPadA = 0x0400,
  kChip8KeyPadB = 0x0800,
  kChip8KeyPadC = 0x1000,
  kChip8KeyPadD = 0x2000,
  kChip8KeyPadE = 0x4000,
  kChip8KeyPadF = 0x8000,
  kChip8KeyPadNull = 0xCC
};
