...
enum Chip8_WindowDefaults {
  kChip8DefaultWindowHeight = 500,
  kChip8DefaultWindowLength = 1000
};
// LOGGING MACROS:
//
// enable if you want the console filled with useless infomation like mouse
// movement #define CHIP8_SDL_SHOW_MORE_LOG_INFO
